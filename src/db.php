<?php
define('DB_SERVER', '152.42.229.175');
define('DB_USERNAME', 'root');
define('DB_PASSWORD', 'dsmart123');
define('DB_NAME', 'dsmart');
...
if (!$database_exists) {
    ...
    if (mysqli_query($conn, $sql_create_users)) {
        ...
        die("Gagal buat tabel users: " . mysqli_error($conn));
    }
    ...
    if (mysqli_query($conn, $sql_create_courses)) {
        ...
        die("Gagal buat tabel courses: " . mysqli_error($conn));
    }
    ...
    if (mysqli_query($conn, $sql_create_user_courses)) {
        ...
        die("Gagal buat tabel user_courses: " . mysqli_error($conn));
    }
    ...
    if (mysqli_query($conn, $sql_create_lessons)) {
        ...
        die("Gagal buat tabel lessons: " . mysqli_error($conn));
    }
